...
export async function DELETE(request, { params }) {
    try {
        ...
        const result = await connection.query("CALL Eliminar_Usuario_Externo(?);", id_usuario);
